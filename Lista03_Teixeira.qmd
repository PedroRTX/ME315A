...
Resposta: Nas duas primeiras QUERYS o resultado é idêntico pois são colunas com variáveis únicas entre si, na última apenas a ordem é alterada.
...
Não, as cláusulas não são logicamente equivalentes. A primeira e a terceira seguem: NOT (C1 AND C2) = (NOT C1) OR (NOT C2), já a segunda cláusula difere dessa regra.
...
Não, as cláusulas não são logicamente equivalentes. A primeira e a terceira seguem: NOT (C1 OR C2) = (NOT C1) AND (NOT C2), já a segunda cláusula difere dessa regra.
